                                ...
                                <div className="relative z-2 p-5 flex flex-col justify-between w-full h-full">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex justify-between items-center gap-3.5">
                                            ...
                                            <a href={item.linkSrc} className="px-4 py-2 deskScreen:px-5 bg-soft-white rounded-sm cursor-pointer text-sm font-advercase text-dark-grey">{item.linkLabel}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
