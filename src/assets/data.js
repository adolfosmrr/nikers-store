export const stories = [
    ...
    },
    {
        ...
        title: [
            'Air Force 1',
            'Low Retro',
            'Una leyenda silenciosa desde 2002.'
        ],
        titleClases: [
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
        ...
        shoesImage: '/images/shoes/air-force-1-low-retro/cover.avif',
        linkLabel: 'Comprar ahora',
        linkSrc: 'nike.com',
        storyBg: '/images/home-carousel/air-force--bg.avif',
    ...
    {
        id: 7,
        profileImg: '/images/home-carousel/jordan-profile.avif',
        profileName: 'Jordan',
        title: [
            'Air Jordan',
            'CMFT Era',
            '¿Zapas facheras que bancan todo el día?'
        ],
        titleClases: [
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
        ...
        newShoesTitle: 'Jordan CMFT Era',
        newShoesPrice: '$115.00',
        subTitle: '¿Zapas facheras que bancan todo el día?'
    },
    {
        id: 9,
        profileImg: '/images/home-carousel/lifestyle-profile.avif',
        ...
        title: [
            'Nike Dunk Low',
            'Retro Premium',
            'La leyenda del básquet de los 80 volvió con todo.'
        ],
        titleClases: [
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
            ['text-soft-white', 'font-advercase', 'text-6xl', 'absolute', 't-0'],
        ...
        shoesImage: '/images/shoes/nike-dunk-low-retro-premium/cover.avif',
        linkLabel: 'Comprar ahora',
        linkSrc: 'nike.com',
        storyBg: '/images/home-carousel/dunk-low--bg.avif',
        newShoesTitle: 'Nike Dunk Low Retro Premium',
        newShoesPrice: '$125.00',
